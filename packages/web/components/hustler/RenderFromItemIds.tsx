...
import { HustlerRenderProps } from 'components/hustler/RenderFromLootId';

type Metadata = {
  image: string;
};

type RenderFromItemIdsProps = Omit<HustlerRenderProps, 'id'> & {
  itemIds: BigNumber[];
};
...
const RenderFromItemIds = ({
  ...
  }, [bgColor, bodyRles, hustlers, itemRles]);
