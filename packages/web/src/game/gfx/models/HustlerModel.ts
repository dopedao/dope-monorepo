...
export default class HustlerModel {
  ...
  createSprites() {
    ...
    this.shadowSprite = this.hustler.scene.add.ellipse(
      this.hustler.x,
      this.hustler.y + this.hustler.height / 1.5,
      this.hustler.width,
    ...
    if (this.mask != undefined)
      this.sprites[CharacterCategories.Mask] = this.hustler.scene.add.sprite(
        this.hustler.x,
        this.hustler.y,
        this.BASE_MAP[CharacterCategories.Mask][this.mask],
      );
