...
// import { useAllOpenedDopesQuery, useAllUnclaimedDopesQuery } from 'generated/graphql';
...
//   const { data: unclaimedDopes } = useAllUnclaimedDopesQuery({
//     endpoint: API_URI,
//   });
...
//   // then updates items in reactive var cache.
//   const { data: openedDopes } = useAllOpenedDopesQuery({
//     endpoint: API_URI,
//   });
...
//             className="dopeGrid"
//           >
//             {visibleItems.map(dope => (
//               <DopeCard
//                 key={`dope-card_${dope.id}_${viewCompactCards}`}
//                 dope={dope}
