...
interface ComponentsInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "footArmor",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "handArmor",
    values: [BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "namePrefixes",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "nameSuffixes",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "necklaces",
    values: [BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "suffix",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "suffixes",
    values: [BigNumberish]
  ): string;
...
export class Components extends BaseContract {
