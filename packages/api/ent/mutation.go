...
type GameHustlerMutation struct {
	...
	typ string
	id *string
		lastPosition *schema.Position
		relations *[]schema.GameHustlerCitizen
		quests *[]schema.GameHustlerQuest
		items *[]schema.GameHustlerItem
		created_at *time.Time
	clearedFields map[string]struct{}
			hustlers *string
...
func (m *GameHustlerMutation) IDs(ctx context.Context) ([]string, error) {
	...
	// LastPosition returns the value of the "lastPosition" field in the mutation.
	...
	// OldLastPosition returns the old "lastPosition" field's value of the GameHustler entity.
	...
	// ResetLastPosition resets all changes to the "lastPosition" field.
	...
	func (m *GameHustlerMutation) SetRelations(shc []schema.GameHustlerCitizen) {
		m.relations = &shc
	}

	// Relations returns the value of the "relations" field in the mutation.
	func (m *GameHustlerMutation) Relations() (r []schema.GameHustlerCitizen, exists bool) {
		v := m.relations
		if v == nil {
			return
		}
	...
	// OldRelations returns the old "relations" field's value of the GameHustler entity.
	// If the GameHustler object wasn't provided to the builder, the object is fetched from the database.
	// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
	func (m *GameHustlerMutation) OldRelations(ctx context.Context) (v []schema.GameHustlerCitizen, err error) {
		if !m.op.Is(OpUpdateOne) {
	...
	func (m *GameHustlerMutation) SetQuests(shq []schema.GameHustlerQuest) {
		m.quests = &shq
	}

	// Quests returns the value of the "quests" field in the mutation.
	func (m *GameHustlerMutation) Quests() (r []schema.GameHustlerQuest, exists bool) {
		v := m.quests
		if v == nil {
			return
		}
	...
	// OldQuests returns the old "quests" field's value of the GameHustler entity.
	// If the GameHustler object wasn't provided to the builder, the object is fetched from the database.
	// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
	func (m *GameHustlerMutation) OldQuests(ctx context.Context) (v []schema.GameHustlerQuest, err error) {
		if !m.op.Is(OpUpdateOne) {
	...
	func (m *GameHustlerMutation) SetItems(shi []schema.GameHustlerItem) {
		m.items = &shi
	}

	// Items returns the value of the "items" field in the mutation.
	func (m *GameHustlerMutation) Items() (r []schema.GameHustlerItem, exists bool) {
		v := m.items
		if v == nil {
			return
		}
	...
	// OldItems returns the old "items" field's value of the GameHustler entity.
	// If the GameHustler object wasn't provided to the builder, the object is fetched from the database.
	// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
	func (m *GameHustlerMutation) OldItems(ctx context.Context) (v []schema.GameHustlerItem, err error) {
		if !m.op.Is(OpUpdateOne) {
	...
	func (m *GameHustlerMutation) ResetCreatedAt() {
		...
		func (m *GameHustlerMutation) SetHustlersID(id string) {
				m.hustlers = &id
		}
	...
	func (m *GameHustlerMutation) ClearHustlers() {
		m.clearedhustlers = true
	}

	
	// HustlersCleared reports if the "hustlers" edge to the Hustler entity was cleared.
	func (m *GameHustlerMutation) HustlersCleared() bool {
		return m.clearedhustlers
	}

	
		// HustlersID returns the "hustlers" edge ID in the mutation.
		func (m *GameHustlerMutation) HustlersID() (id string, exists bool) {
			if m.hustlers != nil {
				return *m.hustlers, true
			}
			return
		}
	...
	// HustlersIDs returns the "hustlers" edge IDs in the mutation.
		// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
		// HustlersID instead. It exists only for internal usage by the builders.
	func (m *GameHustlerMutation) HustlersIDs() (ids []string) {
			if id := m.hustlers; id != nil {
				ids = append(ids, *id)
			}
		return
	}
	...
	func (m *GameHustlerMutation) ResetHustlers() {
		m.hustlers = nil
...
func (m *GameHustlerMutation) Fields() []string {
	fields := make([]string, 0, 5)
		...
		if m.relations != nil {
			fields = append(fields, gamehustler.FieldRelations)
		}
		if m.quests != nil {
			fields = append(fields, gamehustler.FieldQuests)
		}
		if m.items != nil {
			fields = append(fields, gamehustler.FieldItems)
		}
		if m.created_at != nil {
...
func (m *GameHustlerMutation) SetField(name string, value ent.Value) error {
	switch name {
		case gamehustler.FieldLastPosition:
			...
			return nil
		case gamehustler.FieldRelations:
			v, ok := value.([]schema.GameHustlerCitizen)
			if !ok {
				return fmt.Errorf("unexpected type %T for field %s", value, name)
			}
			m.SetRelations(v)
			return nil
		case gamehustler.FieldQuests:
			v, ok := value.([]schema.GameHustlerQuest)
			if !ok {
				return fmt.Errorf("unexpected type %T for field %s", value, name)
			}
			m.SetQuests(v)
			return nil
		case gamehustler.FieldItems:
			v, ok := value.([]schema.GameHustlerItem)
			if !ok {
				return fmt.Errorf("unexpected type %T for field %s", value, name)
			}
			m.SetItems(v)
...
func (m *GameHustlerMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
		if m.hustlers != nil {
			edges = append(edges, gamehustler.EdgeHustlers)
		}
	return edges
}
