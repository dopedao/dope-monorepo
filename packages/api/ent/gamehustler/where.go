...
func ID(id string) predicate.GameHustler {
	...
	func HasHustlers() predicate.GameHustler {
		return predicate.GameHustler(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(HustlersTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, HustlersTable,HustlersColumn),
		)
	...
	func HasHustlersWith(preds ...predicate.Hustler) predicate.GameHustler {
		return predicate.GameHustler(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
