...
// Returns a *NotSingularError when exactly one GameHustlerItem entity is not found.
...
// Returns a *NotSingularError when exactly one GameHustlerItem ID is not found.
