...
// Returns a *NotSingularError when exactly one GameHustlerQuest entity is not found.
...
// Returns a *NotSingularError when exactly one GameHustlerQuest ID is not found.
