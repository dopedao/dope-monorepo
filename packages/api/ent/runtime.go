...
func init() {
	...
	dopeDescClothes := dopeFields[0].Descriptor()
	...
	dopeDescFoot := dopeFields[1].Descriptor()
	...
	dopeDescHand := dopeFields[2].Descriptor()
	...
	dopeDescNeck := dopeFields[3].Descriptor()
	...
	dopeDescRing := dopeFields[4].Descriptor()
	...
	dopeDescWaist := dopeFields[5].Descriptor()
	...
	dopeDescWeapon := dopeFields[6].Descriptor()
	...
	dopeDescDrugs := dopeFields[7].Descriptor()
	...
	dopeDescVehicle := dopeFields[8].Descriptor()
