...
type Order struct {
	...
	ReplacementPattern hexutil.Bytes  `json:"replacement_pattern"`
	StaticTarget       common.Address `json:"static_target"`
	StaticExtradata    hexutil.Bytes  `json:"static_extradata"`
